...
export default function About(props) {
    let myStyle = {
        color: props.navMode==='dark'?'#fff':'black',
        backgroundColor: props.navMode==='dark'?'#454545':'#eee'
    }
  return (
        <div className='container mt-5' >
            <h2 style={{color:props.navMode==='dark'?'#fff':'black'}}>About Us</h2>
                <div style={myStyle} className="accordion" id="accordionPanelsStayOpenExample">
                <div className="accordion-item">
                    <h2 style={myStyle} className="accordion-header" id="panelsStayOpen-headingOne">
